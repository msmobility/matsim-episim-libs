...
public final class InfectionModelWithSeasonality implements InfectionModel {
	...
	public double calcInfectionProbability(EpisimPerson target, EpisimPerson infector, Map<String, Restriction> restrictions,
		...
		double susceptibility = Math.min(DefaultInfectionModel.getVaccinationEffectiveness(strain, target, vaccinationConfig, iteration), DefaultInfectionModel.getImmunityEffectiveness(strain, target, vaccinationConfig, iteration));
